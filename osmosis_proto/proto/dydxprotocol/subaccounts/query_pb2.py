...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals["_QUERYGETSUBACCOUNTREQUEST"].fields_by_name[
        "owner"
    ...
    _globals["_QUERYCOLLATERALPOOLADDRESSRESPONSE"].fields_by_name[
        "collateral_pool_address"
    ]._serialized_options = b"\322\264-\024cosmos.AddressString"
    _globals["_QUERY"].methods_by_name["Subaccount"]._loaded_options = None
    _globals["_QUERY"].methods_by_name[
        "Subaccount"
    ]._serialized_options = b"\202\323\344\223\0027\0225/dydxprotocol/subaccounts/subaccount/{owner}/{number}"
    _globals["_QUERY"].methods_by_name["SubaccountAll"]._loaded_options = None
    _globals["_QUERY"].methods_by_name[
        "SubaccountAll"
    ]._serialized_options = b"\202\323\344\223\002&\022$/dydxprotocol/subaccounts/subaccount"
    ...
    _globals["_QUERY"].methods_by_name[
        ...
        b"\202\323\344\223\002Q\022O/dydxprotocol/subaccounts/withdrawals_and_transfers_blocked_info/{perpetual_id}"
    )
    _globals["_QUERY"].methods_by_name["CollateralPoolAddress"]._loaded_options = None
    _globals["_QUERY"].methods_by_name[
        "CollateralPoolAddress"
    ]._serialized_options = (
        b"\202\323\344\223\002B\022@/dydxprotocol/subaccounts/collateral_pool_address/{perpetual_id}"
    )
