...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['DESCRIPTOR']._serialized_options = b'ZNgithub.com/osmosis-labs/osmosis/v25/x/concentrated-liquidity/client/queryproto'
  ...
  _globals['_NUMPOOLPOSITIONSREQUEST'].fields_by_name['pool_id']._serialized_options = b'\362\336\037\016yaml:\"pool_id\"'
  _globals['_NUMPOOLPOSITIONSRESPONSE'].fields_by_name['position_count']._loaded_options = None
  _globals['_NUMPOOLPOSITIONSRESPONSE'].fields_by_name['position_count']._serialized_options = b'\362\336\037\025yaml:\"position_count\"'
  ...
  _globals['_TICKLIQUIDITYNET'].fields_by_name['liquidity_net']._serialized_options = b'\310\336\037\000\332\336\037\033cosmossdk.io/math.LegacyDec\362\336\037\024yaml:\"liquidity_net\"'
  ...
  _globals['_LIQUIDITYDEPTHWITHRANGE'].fields_by_name['liquidity_amount']._serialized_options = b'\310\336\037\000\332\336\037\033cosmossdk.io/math.LegacyDec\362\336\037\024yaml:\"liquidity_net\"'
  ...
  _globals['_LIQUIDITYNETINDIRECTIONRESPONSE'].fields_by_name['current_liquidity']._serialized_options = b'\310\336\037\000\332\336\037\033cosmossdk.io/math.LegacyDec\362\336\037\030yaml:\"current_liquidity\"'
  _globals['_LIQUIDITYNETINDIRECTIONRESPONSE'].fields_by_name['current_sqrt_price']._loaded_options = None
  _globals['_LIQUIDITYNETINDIRECTIONRESPONSE'].fields_by_name['current_sqrt_price']._serialized_options = b'\310\336\037\000\332\336\037/github.com/osmosis-labs/osmosis/osmomath.BigDec\362\336\037\031yaml:\"current_sqrt_price\"'
  ...
  _globals['_LIQUIDITYPERTICKRANGERESPONSE'].fields_by_name['bucket_index']._serialized_options = b'\362\336\037\023yaml:\"bucket_index\"'
  ...
  _globals['_POOLACCUMULATORREWARDSREQUEST'].fields_by_name['pool_id']._serialized_options = b'\362\336\037\016yaml:\"pool_id\"'
  _globals['_POOLACCUMULATORREWARDSRESPONSE'].fields_by_name['spread_reward_growth_global']._loaded_options = None
  _globals['_POOLACCUMULATORREWARDSRESPONSE'].fields_by_name['spread_reward_growth_global']._serialized_options = b'\310\336\037\000\252\337\037+github.com/cosmos/cosmos-sdk/types.DecCoins'
  _globals['_POOLACCUMULATORREWARDSRESPONSE'].fields_by_name['uptime_growth_global']._loaded_options = None
  _globals['_POOLACCUMULATORREWARDSRESPONSE'].fields_by_name['uptime_growth_global']._serialized_options = b'\310\336\037\000\362\336\037\033yaml:\"uptime_growth_global\"'
  _globals['_TICKACCUMULATORTRACKERSREQUEST'].fields_by_name['pool_id']._loaded_options = None
  _globals['_TICKACCUMULATORTRACKERSREQUEST'].fields_by_name['pool_id']._serialized_options = b'\362\336\037\016yaml:\"pool_id\"'
  _globals['_TICKACCUMULATORTRACKERSREQUEST'].fields_by_name['tick_index']._loaded_options = None
  _globals['_TICKACCUMULATORTRACKERSREQUEST'].fields_by_name['tick_index']._serialized_options = b'\362\336\037\021yaml:\"tick_index\"'
  _globals['_TICKACCUMULATORTRACKERSRESPONSE'].fields_by_name['spread_reward_growth_opposite_direction_of_last_traversal']._loaded_options = None
  _globals['_TICKACCUMULATORTRACKERSRESPONSE'].fields_by_name['spread_reward_growth_opposite_direction_of_last_traversal']._serialized_options = b'\310\336\037\000\252\337\037+github.com/cosmos/cosmos-sdk/types.DecCoins'
  _globals['_TICKACCUMULATORTRACKERSRESPONSE'].fields_by_name['uptime_trackers']._loaded_options = None
  _globals['_TICKACCUMULATORTRACKERSRESPONSE'].fields_by_name['uptime_trackers']._serialized_options = b'\310\336\037\000\362\336\037\026yaml:\"uptime_trackers\"'
  _globals['_INCENTIVERECORDSREQUEST'].fields_by_name['pool_id']._loaded_options = None
  _globals['_INCENTIVERECORDSREQUEST'].fields_by_name['pool_id']._serialized_options = b'\362\336\037\016yaml:\"pool_id\"'
  ...
  _globals['_CFMMPOOLIDLINKFROMCONCENTRATEDPOOLIDREQUEST'].fields_by_name['concentrated_pool_id']._loaded_options = None
  _globals['_CFMMPOOLIDLINKFROMCONCENTRATEDPOOLIDREQUEST'].fields_by_name['concentrated_pool_id']._serialized_options = b'\362\336\037\033yaml:\"concentrated_pool_id\"'
  _globals['_CFMMPOOLIDLINKFROMCONCENTRATEDPOOLIDRESPONSE'].fields_by_name['cfmm_pool_id']._loaded_options = None
  _globals['_CFMMPOOLIDLINKFROMCONCENTRATEDPOOLIDRESPONSE'].fields_by_name['cfmm_pool_id']._serialized_options = b'\362\336\037\023yaml:\"cfmm_pool_id\"'
  _globals['_USERUNBONDINGPOSITIONSREQUEST'].fields_by_name['address']._loaded_options = None
  _globals['_USERUNBONDINGPOSITIONSREQUEST'].fields_by_name['address']._serialized_options = b'\362\336\037\016yaml:\"address\"'
  _globals['_USERUNBONDINGPOSITIONSRESPONSE'].fields_by_name['positions_with_period_lock']._loaded_options = None
  _globals['_USERUNBONDINGPOSITIONSRESPONSE'].fields_by_name['positions_with_period_lock']._serialized_options = b'\310\336\037\000'
  _globals['_GETTOTALLIQUIDITYRESPONSE'].fields_by_name['total_liquidity']._loaded_options = None
  _globals['_GETTOTALLIQUIDITYRESPONSE'].fields_by_name['total_liquidity']._serialized_options = b'\310\336\037\000\252\337\037(github.com/cosmos/cosmos-sdk/types.Coins'
  _globals['_NUMNEXTINITIALIZEDTICKSREQUEST'].fields_by_name['pool_id']._loaded_options = None
  _globals['_NUMNEXTINITIALIZEDTICKSREQUEST'].fields_by_name['pool_id']._serialized_options = b'\362\336\037\016yaml:\"pool_id\"'
  _globals['_NUMNEXTINITIALIZEDTICKSREQUEST'].fields_by_name['token_in_denom']._loaded_options = None
  _globals['_NUMNEXTINITIALIZEDTICKSREQUEST'].fields_by_name['token_in_denom']._serialized_options = b'\362\336\037\025yaml:\"token_in_denom\"'
  _globals['_NUMNEXTINITIALIZEDTICKSREQUEST'].fields_by_name['num_next_initialized_ticks']._loaded_options = None
  _globals['_NUMNEXTINITIALIZEDTICKSREQUEST'].fields_by_name['num_next_initialized_ticks']._serialized_options = b'\362\336\037!yaml:\"num_next_initialized_ticks\"'
  _globals['_NUMNEXTINITIALIZEDTICKSRESPONSE'].fields_by_name['liquidity_depths']._loaded_options = None
  _globals['_NUMNEXTINITIALIZEDTICKSRESPONSE'].fields_by_name['liquidity_depths']._serialized_options = b'\310\336\037\000'
  _globals['_NUMNEXTINITIALIZEDTICKSRESPONSE'].fields_by_name['current_liquidity']._loaded_options = None
  _globals['_NUMNEXTINITIALIZEDTICKSRESPONSE'].fields_by_name['current_liquidity']._serialized_options = b'\310\336\037\000\332\336\037\033cosmossdk.io/math.LegacyDec\362\336\037\030yaml:\"current_liquidity\"'
  ...
  _globals['_QUERY'].methods_by_name['PoolAccumulatorRewards']._serialized_options = b'\202\323\344\223\002;\0229/osmosis/concentratedliquidity/v1beta1/pool_accum_rewards'
  _globals['_QUERY'].methods_by_name['IncentiveRecords']._loaded_options = None
  _globals['_QUERY'].methods_by_name['IncentiveRecords']._serialized_options = b'\202\323\344\223\002:\0228/osmosis/concentratedliquidity/v1beta1/incentive_records'
  _globals['_QUERY'].methods_by_name['TickAccumulatorTrackers']._loaded_options = None
  _globals['_QUERY'].methods_by_name['TickAccumulatorTrackers']._serialized_options = b'\202\323\344\223\002<\022:/osmosis/concentratedliquidity/v1beta1/tick_accum_trackers'
  _globals['_QUERY'].methods_by_name['CFMMPoolIdLinkFromConcentratedPoolId']._loaded_options = None
  _globals['_QUERY'].methods_by_name['CFMMPoolIdLinkFromConcentratedPoolId']._serialized_options = b'\202\323\344\223\002c\022a/osmosis/concentratedliquidity/v1beta1/cfmm_pool_id_link_from_concentrated/{concentrated_pool_id}'
  _globals['_QUERY'].methods_by_name['UserUnbondingPositions']._loaded_options = None
  _globals['_QUERY'].methods_by_name['UserUnbondingPositions']._serialized_options = b'\202\323\344\223\002K\022I/osmosis/concentratedliquidity/v1beta1/user_unbonding_positions/{address}'
  _globals['_QUERY'].methods_by_name['GetTotalLiquidity']._loaded_options = None
  _globals['_QUERY'].methods_by_name['GetTotalLiquidity']._serialized_options = b'\202\323\344\223\002<\022:/osmosis/concentratedliquidity/v1beta1/get_total_liquidity'
  _globals['_QUERY'].methods_by_name['NumNextInitializedTicks']._loaded_options = None
  _globals['_QUERY'].methods_by_name['NumNextInitializedTicks']._serialized_options = b'\202\323\344\223\002C\022A/osmosis/concentratedliquidity/v1beta1/num_next_initialized_ticks'
